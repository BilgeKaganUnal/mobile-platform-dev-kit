...
class TrackingPermissionsService {
  ...
  async initialize(): Promise<TrackingPermissionResult> {
    logger.info('TrackingPermissions: Initializing...');
    ...
    try {
      ...
      logger.info('TrackingPermissions: Current status retrieved', {
        status: this._currentStatus,
  ...
  async requestPermissions(): Promise<TrackingPermissionResult> {
    logger.info('TrackingPermissions: Requesting permissions...');
    ...
    try {
      ...
      logger.info('TrackingPermissions: Permission request completed', {
        status: this._currentStatus,
        canTrack: this.canTrack
      });
  ...
  reset(): void {
    ...
    logger.info('TrackingPermissions: Service reset');
  }
